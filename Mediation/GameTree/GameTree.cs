...
namespace Mediation.GameTree
{
    ...
    public class GameTree
    {
        ...
        /// <summary>
        /// Stores how many times a node in the tree has been played.
        /// </summary>
        ...
        /// <summary>
        /// Stores how many times a winning node has been created.
        /// </summary>
        ...
        /// <summary>
        /// Stores how many times a losing node has been created.
        /// </summary>
        ...
        /// <returns></returns>
        public double GetInterval (int id)
        {
            // If the current node is valid, get its interval.
            if (ValidNode(id)) return GetInterval(GetNode(id));
        ...
        public GameTreeNode CreateNode (Domain domain, Problem problem, GameTreeEdge incoming)
        {
            ...
            if (incoming == null) node = new GameTreeNode(domain, problem, 0);
